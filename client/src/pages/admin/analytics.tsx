...
export default function AnalyticsDashboard() {
  ...
  const calculateSummaryMetrics = () => {
    ...
    const totalVisitors = visitorData.reduce((sum: number, day: any) => sum + day.visitors, 0);
    const totalPageViews = visitorData.reduce((sum: number, day: any) => sum + day.pageViews, 0);
    const totalSessions = visitorData.reduce((sum: number, day: any) => sum + day.sessions, 0);
