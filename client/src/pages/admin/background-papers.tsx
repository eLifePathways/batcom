...
export default function BackgroundPapersAdmin() {
  ...
  const [selectedPaper, setSelectedPaper] = useState<BackgroundPaper | null>(
    null,
  )
              ...
              <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      handleSelectChange('virusCategoryId', value)
                    }
                  >
                    <SelectTrigger>
                ...
                <ImageUpload
                  ...
                  label="Paper Image"
                  description="Upload an image for this background paper (PNG, JPG up to 10MB)"
                />
                ...
                <DialogFooter>
                  <DialogClose asChild>
                    <Button
                      type="submit"
                      disabled={
                        addBackgroundPaper.isPending ||
                        updateBackgroundPaper.isPending
                      }
                    >
                      {addBackgroundPaper.isPending ||
                      updateBackgroundPaper.isPending
                ...
                [...(backgroundPapers || [])]
                  ...
                  .map(paper => (
                    <TableRow key={paper.id}>
                      ...
                      <TableCell>
                        {getVirusCategoryName(paper.virusCategoryId)}
                      </TableCell>
                      <TableCell>
                        {paper.link ? (
                          <a
                          ...
                          <Dialog>
                            ...
                            <DialogContent className="max-w-2xl">
                              ...
                              >
                                ...
                                <div className="space-y-2">
                                  <Label htmlFor="edit-virusCategoryId">
                                    Virus Category *
                                  </Label>
                                  <Select
                                    value={formData.virusCategoryId?.toString()}
                                ...
                                <DialogFooter>
                                  <DialogClose asChild>
                                    <Button
                                      type="submit"
                                      disabled={updateBackgroundPaper.isPending}
                                    >
                                      {updateBackgroundPaper.isPending
                                        ? 'Saving...'
                                        : 'Save Changes'}
                              ...
                              <DialogFooter>
                                <DialogClose asChild>
                                  <Button
                                    variant="destructive"
                                    onClick={() =>
                                      deleteBackgroundPaper.mutate(paper.id)
                                    }
                                    disabled={deleteBackgroundPaper.isPending}
                                  >
                                    {deleteBackgroundPaper.isPending
                                      ? 'Deleting...'
                                      : 'Delete'}
                                  </Button>
                                </DialogClose>
