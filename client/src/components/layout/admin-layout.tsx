...
const AdminSidebar = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      active:
        location === '/admin/virus-categories' ||
        location.startsWith('/admin/virus-categories/'),
    },
    {
      ...
      active:
        ...
        location.startsWith('/admin/publications/'),
    },
    {
      ...
      active:
        location === '/admin/background-papers' ||
        location.startsWith('/admin/background-papers/'),
    },
    {
      ...
      active:
        location === '/admin/what-we-do' ||
        location.startsWith('/admin/what-we-do/'),
    },
    {
      href: '/admin/users',
      ...
      active:
        location === '/admin/users' || location.startsWith('/admin/users/'),
    },
    {
      href: '/admin/issues',
      label: 'Issue Reports',
      ...
      active:
        location === '/admin/issues' || location.startsWith('/admin/issues/'),
    },
    {
    ...
    },
    {
      ...
      active:
        location === '/admin/graphql' || location.startsWith('/admin/graphql/'),
    },
    {
      href: '/admin/settings',
      label: 'Settings',
