...
import { Home, Users, BookOpen, FileText, Bug, Settings, BarChart } from "lucide-react";
...
export default function AdminNav() {
  ...
  const navItems = [
    ...
    },
    {
      ...
      active: location === "/admin/team",
    },
    {
      href: "/admin/virus-categories",
      label: "Virus Categories",
      icon: <Bug className="h-5 w-5" />,
      active: location === "/admin/virus-categories",
    },
    {
      href: "/admin/publications",
      label: "Publications",
      icon: <BookOpen className="h-5 w-5" />,
      active: location === "/admin/publications",
    },
    {
