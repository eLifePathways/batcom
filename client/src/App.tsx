    ...
    return (
      <AdminLayout>
        <Switch>
          ...
          <Route
            path="/admin/publications/:action"
            component={AdminPublications}
          />
          <Route
            path="/admin/background-papers"
            component={AdminBackgroundPapers}
          />
          <Route
            path="/admin/background-papers/:action"
            component={AdminBackgroundPapers}
          />
          <Route
            path="/admin/virus-categories"
            component={AdminVirusCategories}
          />
          <Route
            path="/admin/virus-categories/:action"
            component={AdminVirusCategories}
          />
